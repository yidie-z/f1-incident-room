...
export const content: IncidentContent = {
  ...
  fiaDecision: {
    ...
    plain:
      '通俗解读：你是被套圈的车，车队也提醒过你后面来车了，结果你在出弯时切回赛车线撞上了正在套你圈的领先车——责任在你。但考虑到他当时确实在你的后视镜死角里（180 度弯的外线位置看不到紧贴内线的车），情有可原，所以只罚最低的 5 秒，没按 10 秒档处理。至于"方向盘蓝灯坏了"——干事不接受这个当借口：后视镜和实体蓝旗灯板一直都在，提醒义务不会被系统故障免除。',
    rules: [
      ...
      '处罚与后果的不对等：塞恩斯最终 P18 完赛，自称"我在争 P18，5 秒无所谓"；而皮亚斯特里因此丢掉领先（诺里斯 overcut 得手并最终夺冠），第 56 圈又遭遇变速箱故障退赛——"罚 5 秒换走一场胜利"的争论正是这个页面的存在意义。',
    ],
    sources: [
      {
